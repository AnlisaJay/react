...
app.get('/products', async (req, res) => {
    ...
    /* const products = [
         ...
         {id: 2, header: 'Товар 2', price: 3800 },
         {id: 3, header: 'Товар 3', price: 570 },
         {id: 4, header: 'Товар 4', price: 240 },
         {id: 5, header: 'Товар 5', price: 100 },
         {id: 6, header: 'Товар 6', price: 739 },
         {id: 7, header: 'Товар 7', price: 130 },
         {id: 8, header: 'Товар 8', price: 876 }
       ] */
